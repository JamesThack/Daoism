...
public class TileEntityPillFurnace extends TileEntity implements ITickable {
    ...
    public static boolean isBurning(TileEntityPillFurnace te)
    {
    ...
    public void update()
    {
        ...
        {
            --this.burnTime;
            BlockPillFurnace.setState(true, world, pos);
        }
        ...
        else
        {
            ...
            {
                ItemStack output = PillFurnaceRecipes.getInstance().getSinteringResult(inputs[0], inputs[1]);
                if(!output.isEmpty())
                {
                    smelting = output;
                    cookTime++;
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = PillFurnaceRecipes.getInstance().getSinteringResult((ItemStack)this.handler.getStackInSlot(0), (ItemStack)this.handler.getStackInSlot(1));
